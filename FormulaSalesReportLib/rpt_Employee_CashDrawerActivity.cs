...
{
    public partial class rpt_Employee_CashDrawerActivity : rpt
    {
        public rpt_Employee_CashDrawerActivity()
        {
            InitializeComponent();
        }
        ...
        private void rpt_Sales_CreditCardTrans_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            xrLabel4.DataBindings.Add("Text", DataSource, "Data");
            ...
            xrLabel3.DataBindings.AddRange(new XRBinding[] { new XRBinding("Text", DataSource, "Data1") });
