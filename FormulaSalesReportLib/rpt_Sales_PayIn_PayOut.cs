...
{
    public partial class rpt_Sales_PayIn_PayOut : rpt
    {
        public rpt_Sales_PayIn_PayOut()
        {
            InitializeComponent();
        }
        ...
        private void rpt_Sales_CreditCardTrans_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            try
            {
                ...
                XRSummary XrSummary1 = new XRSummary();
                lblTotalData3.DataBindings.AddRange(new XRBinding[] { new XRBinding("Text", this.DataSource, "Data") });
                XrSummary1.FormatString = "{0}";
                XrSummary1.Func = SummaryFunc.Sum;
                XrSummary1.Running = SummaryRunning.Report;
                lblTotalData3.Summary = XrSummary1;
