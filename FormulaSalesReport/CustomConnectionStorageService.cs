...
namespace FormulaSalesReport
{
    class CustomConnectionStorageService : IConnectionStorageService
    {
        ...
        private SqlDataConnection GetConnection()
        {
            MySqlConnectionParameters newMySqlConnectionParameters = new MySqlConnectionParameters("localhost", "purepos", "root", "root", "3306");
            
            //CustomSqlDataConnection newMySqlConnectionParameters = new CustomSqlDataConnection("Default Connection", newMySqlConnectionParameters);
            return new SqlDataConnection("PlazSales Connection", newMySqlConnectionParameters);
        }
