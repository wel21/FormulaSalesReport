...
namespace FormulaSalesReport
{
    public partial class Form1 : Form
    {
        ...
        FormulaSalesReport.SalesReportControl SR = new FormulaSalesReport.SalesReportControl();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            SR.ParamDate.Add(new ParamDate(Convert.ToDateTime("09/01/2017"), ParameterCondition.OR));
            SR.ParamDate.Add(new ParamDate(Convert.ToDateTime("09/03/2017"), ParameterCondition.OR));
            SR.ParamDate.Add(new ParamDate(Convert.ToDateTime("09/05/2017"), ParameterCondition.OR));
            SR.LoadReport(LoadReportType.GrossSalesSummarybyHours);
            SR.ShowPrintButton = true;

            //connection settings has default values but can be modified
            FormulaSalesReport.DatabaseConnectionSettings.Server = "Localhost";
            FormulaSalesReport.DatabaseConnectionSettings.User = "root";
            FormulaSalesReport.DatabaseConnectionSettings.Password = "root";
            FormulaSalesReport.DatabaseConnectionSettings.Database = "purepos";
            FormulaSalesReport.DatabaseConnectionSettings.Port = "3306";
